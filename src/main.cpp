 ...
 * - Spécialisation de la classe Sprite pour qu'il suive le mouvement de la souris (voir \ref mouse_move_detection).
 * - Création de l'animation d'un sprite au moyen d'une spritesheet (voir \ref mouse_move_detection).
