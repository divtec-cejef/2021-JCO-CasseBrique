...
//! - Modification du point de positionnement d'un sprite avec Sprite::setOffset() afin que la
//!   coordonnée de la roue tournante ne soit pas son coin supérieur gauche, mais son centre.
